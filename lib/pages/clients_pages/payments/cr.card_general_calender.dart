...
import 'package:handy_home2/pages/clients_pages/payments/general_calender_invoice.dart';

class GeneralCalenderCreditCardPage extends StatefulWidget {
  ...
  const GeneralCalenderCreditCardPage({
    super.key,
  ...
  @override
  State<GeneralCalenderCreditCardPage> createState() =>
      _GeneralCalenderCreditCardPageState();
}

class _GeneralCalenderCreditCardPageState extends State<GeneralCalenderCreditCardPage> {
  String cardNumber = '';
  String expiryDate = '';
          ...
          Navigator.pushReplacement(
            ...
            MaterialPageRoute(
              builder: (_) => GeneralInvoicePage(
                ...
                date: widget.date,
                time: widget.time,
                estimatedDuration: Duration(hours: widget.estimatedTime),
