...
class BabysitterWorkersPage extends StatefulWidget {
  final double totalPrice;
  final int EstimatedTime;
  final String selectedSpecialization;

  const BabysitterWorkersPage({ super.key,
  ...
  @override
  State<BabysitterWorkersPage> createState() => _BabysitterWorkersPageState();
}

class _BabysitterWorkersPageState extends State<BabysitterWorkersPage> {
