...
class ElectricalWorkersPage extends StatefulWidget {
  ...
  const ElectricalWorkersPage({super.key,
  ...
  @override
  State<ElectricalWorkersPage> createState() => _ElectricalWorkersPageState();
}

class _ElectricalWorkersPageState extends State<ElectricalWorkersPage> {
