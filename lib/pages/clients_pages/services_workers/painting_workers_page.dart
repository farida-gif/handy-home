...
class PaintingWorkersPage extends StatefulWidget {

  final double totalPrice;
  final int estimatedTime;
  final String selectedSpecialization;

  const PaintingWorkersPage({super.key,
  required this.totalPrice,
  required this.estimatedTime,
  required this.selectedSpecialization,});

  @override
  State<PaintingWorkersPage> createState() => _PaintingWorkersPageState();
}

class _PaintingWorkersPageState extends State<PaintingWorkersPage> {
  ...
  Future<void> _loadWorkers() async {
    ...
    try {
      final List<Map<String, dynamic>> workerData =
          await _repo.fetchWorkersForService('Painting');
