...
class PlumbingWorkersPage extends StatefulWidget {
  final double totalPrice;
  final int estimatedTime;
  final String selectedSpecialization;

  const PlumbingWorkersPage({super.key,
   required this.totalPrice,
    required this.estimatedTime,
    required this.selectedSpecialization});

  @override
  State<PlumbingWorkersPage> createState() => _PlumbingWorkersPageState();
}

class _PlumbingWorkersPageState extends State<PlumbingWorkersPage> {
  ...
  Future<void> _loadWorkers() async {
    ...
    try {
      final List<Map<String, dynamic>> workerData =
          await _repo.fetchWorkersForService('Plumbing');
